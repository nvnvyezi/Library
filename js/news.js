...
var Rank = function(arr){     //	添加图书收藏
	...
	script.src = 'https://api.xiyoumobile.com/xiyoulibv2/news/getList/news/1?callback=Fnrank';
...
var Pagefourrequest = function(str){
	var script = document.createElement('script');
    script.type = 'text/javascript';
    script.src = 'https://api.xiyoumobile.com/xiyoulibv2/news/getDetail/news/html';
